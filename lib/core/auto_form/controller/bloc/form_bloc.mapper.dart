...
class FormStateMapper extends ClassMapperBase<FormState> {
  ...
  static List<FormValue<Object?>> _$inputs(FormState v) => v.values;
  static const Field<FormState, List<FormValue<Object?>>> _f$inputs = Field(
    'inputs',
    _$inputs,
  );
  static bool _$isEditing(FormState v) => v.isEditing;
  static const Field<FormState, bool> _f$isEditing = Field(
    'isEditing',
    _$isEditing,
    key: r'is_editing',
  );
  static bool _$showErrors(FormState v) => v.showErrors;
  static const Field<FormState, bool> _f$showErrors = Field(
    'showErrors',
    _$showErrors,
    key: r'show_errors',
  );
...
mixin FormStateMappable {
  String toJson() {
    return FormStateMapper.ensureInitialized().encodeJson<FormState>(
      this as FormState,
    );
  }

  Map<String, dynamic> toMap() {
    return FormStateMapper.ensureInitialized().encodeMap<FormState>(
      this as FormState,
    );
  }
  ...
  @override
  String toString() {
    return FormStateMapper.ensureInitialized().stringifyValue(
      this as FormState,
    );
  }
  ...
  bool operator ==(Object other) {
    return FormStateMapper.ensureInitialized().equalsValue(
      this as FormState,
      other,
    );
  }
