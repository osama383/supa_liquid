...
class SideSheet {
  ...
  static Future<dynamic> left({
    ...
    /// Default is scrim color with 0.25 opacity
    Color? barrierColor,
  ...
  static _showSheetSide({
    ...
    return showGeneralDialog(
      ...
      barrierDismissible: barrierDismissible,
      barrierColor:
          barrierColor ?? Theme.of(context).colorScheme.scrim.withAlpha(60),
      transitionDuration: transitionDuration,
      context: context,
